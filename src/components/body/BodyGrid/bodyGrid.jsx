...
export default function BodyGrid(){
    return <Box p="50px">
        ...
        {/* <Grid templateColumns='repeat(5, 1fr)' gap={6} m="auto" mt="10" width="90%" style={Styles}> */}
        <Grid gridTemplateColumns={["repeat(2, 1fr)", "repeat(3, 1fr)", "repeat(5, 1fr)"]} gap={6} m="auto" mt="10" width="90%">
